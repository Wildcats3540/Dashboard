...
public class HoughTransform extends Thread { 
	...
	public void start(BufferedImage Image){
    	...
    	image = Image;
    	set(Image.getWidth(),Image.getHeight());
    	System.out.println(width);
    	System.out.println(height);
        addPoints(image); 
 
        // get the lines out 
        Vector<HoughLine> lines = getLines(100); 
    ...
    public BufferedImage getHoughArrayImage() { 
        ...
        BufferedImage image2 = new BufferedImage(maxTheta, doubleHeight, BufferedImage.TYPE_INT_ARGB); 
        for (int t = 0; t < maxTheta; t++) { 
            for (int r = 0; r < doubleHeight; r++) { 
